...
package com.swiftbrowser.fast.secure.tools

import android.util.Log
import com.swiftbrowser.fast.secure.ai.engine.LexiconTranslationEngine
import com.swiftbrowser.fast.secure.ai.engine.ModelBackedTranslationEngine
import com.swiftbrowser.fast.secure.ai.engine.OfflineTranslationEngine
import com.swiftbrowser.fast.secure.ai.engine.TranslationEngineManager
import com.swiftbrowser.fast.secure.ai.models.ModelPlatform
import com.swiftbrowser.fast.secure.ai.models.ModelTask
import com.swiftbrowser.fast.secure.ai.translation.OnlineTranslationProvider
import com.swiftbrowser.fast.secure.ai.translation.OfflineTranslationProvider
import com.swiftbrowser.fast.secure.ai.translation.TranslationCoordinator
import com.swiftbrowser.fast.secure.ai.translation.TranslationMode
import com.swiftbrowser.fast.secure.ai.translation.TranslationResult
...
class TranslationManager(platform: ModelPlatform? = null) {
    ...
    val mangaPipeline: com.swiftbrowser.fast.secure.ai.manga.MangaTranslationPipeline by lazy {
        com.swiftbrowser.fast.secure.ai.manga.MangaTranslationPipeline(coordinator)
    }
