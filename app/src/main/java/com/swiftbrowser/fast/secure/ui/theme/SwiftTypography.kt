...
package com.swiftbrowser.fast.secure.ui.theme
...
val SwiftTypography = Typography(
    ...
    headlineLarge = TextStyle(
        fontFamily = FontFamily.SansSerif,
        fontWeight = FontWeight.Normal, // Prevent aggressive boldness
        fontSize = 32.sp,
        lineHeight = 40.sp,
        letterSpacing = 0.sp
    ),
    ...
    bodyLarge = TextStyle(
        ...
        fontWeight = FontWeight.Normal,
        fontSize = 16.sp,
        lineHeight = 24.sp, // 8dp grid alignment
        letterSpacing = 0.5.sp // Breathe
    ),
