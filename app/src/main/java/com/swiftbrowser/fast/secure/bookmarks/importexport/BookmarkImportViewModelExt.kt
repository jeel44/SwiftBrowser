...
package com.swiftbrowser.fast.secure.bookmarks.importexport

import android.content.Context
import android.net.Uri
import androidx.lifecycle.viewModelScope
import com.swiftbrowser.fast.secure.bookmarks.model.BookmarkNode
import com.swiftbrowser.fast.secure.bookmarks.export.exportNetscapeBookmarkHtml
import com.swiftbrowser.fast.secure.bookmarks.parser.parseNetscapeBookmarkHtml
    ...
    viewModelScope.launch(Dispatchers.IO) {
        try {
            ...
            val uri = androidx.core.content.FileProvider.getUriForFile(
                context,
                "com.swiftbrowser.fast.secure.fileprovider",
                file
            )
